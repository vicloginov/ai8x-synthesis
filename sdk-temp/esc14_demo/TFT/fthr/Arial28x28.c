...
/* Arial font italic with 28*28 pixel matrix for Adafruit 2.4" TFT FeatherWing */

__attribute__((section(".bin_storage_img"))) __attribute__((__used__))
__attribute__ ((aligned (2)))
const unsigned char Arial28x28[] = {
113, 28, 28, 4,	// number of bytes per character; horizontal size in pixels; vertical size in pixels; number of bytes per vertical line
